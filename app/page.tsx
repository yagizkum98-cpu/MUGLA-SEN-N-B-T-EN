  ...
  return <main className="relative min-h-screen overflow-hidden bg-mugla-sand text-mugla-navy">
    ...
    <section className="mx-auto max-w-6xl px-5 py-14">
      <div className="relative flex min-h-[260px] flex-col items-center justify-center gap-8 overflow-hidden rounded-lg border border-mugla-navy/10 bg-white px-6 py-10 shadow-soft sm:flex-row sm:gap-14">
        ...
        <div className="relative flex h-24 w-full max-w-[250px] items-center justify-center rounded-2xl bg-white/85 p-4 shadow-sm backdrop-blur-[2px]">
          <Image src="/partners/muski.svg" alt="Muğla Su ve Kanalizasyon İdaresi MUSKİ" width={512} height={512} className="h-full w-full object-contain"/>
        </div>
        <div className="relative hidden h-16 w-px bg-mugla-navy/15 sm:block"/>
