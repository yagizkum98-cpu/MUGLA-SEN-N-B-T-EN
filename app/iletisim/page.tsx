  ...
  return <main className="min-h-screen bg-mugla-sand">
    <header className="border-b border-mugla-navy/10 bg-white">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
        ...
        <div className="flex items-center gap-3"><span className="hidden text-xs font-bold tracking-[.18em] text-mugla-orange sm:block">MUĞLA BÜTÇE SENİN</span><SiteUserMenu/></div>
      </div>
    </header>
