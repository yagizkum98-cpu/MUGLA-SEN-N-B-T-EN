...
export default function DistrictLoginPage(){
  return <AdminAuthGate><Suspense fallback={<main className="grid min-h-screen place-items-center bg-mugla-sand p-6"><div className="rounded-3xl bg-white p-8 shadow-soft">Giris hazirlaniyor...</div></main>}><DistrictLoginForm/></Suspense></AdminAuthGate>
}
