...
export function getCurrentUser(){if(typeof window==='undefined')return null;const id=localStorage.getItem(SESSION);return readUsers().find(user=>user.id===id)??null}
