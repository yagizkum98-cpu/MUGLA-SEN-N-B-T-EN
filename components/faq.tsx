...
const faqs=[
  ['Muğla Bütçe Senin nedir?','Vatandaşların, gençlerin, sivil toplum kuruluşlarının, akademisyenlerin, girişimcilerin ve Muğla’yı ziyaret eden kişilerin proje önerileri sunabildiği, projeleri değerlendirebildiği ve bütçe süreçlerine katılabildiği dijital katılımcı bütçe platformudur.'],
  ...
  ['Muğla Bütçe Senin neden önemlidir?','Çünkü şehirler, o şehirde yaşayan ve şehri deneyimleyen insanların ortak aklıyla daha doğru gelişir. Platform bu ortak aklı dijital ortamda bir araya getirir.']
] as const
