...
export function Card({className,...p}:React.HTMLAttributes<HTMLDivElement>){return <div className={cn('fade-up-card rounded-3xl border border-mugla-navy/10 bg-white shadow-soft',className)} {...p}/>}
